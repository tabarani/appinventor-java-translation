...
{
    private String identifier, returnType;
    ...
    public FunctionSegment( String identifier, CodeVisibility visibility, String returnType, Collection<Parameter> params )
    {
        this.identifier = identifier;
        setReturnType( returnType );
        this.visibility = visibility;
    ...
    private void setParameters( Collection<Parameter> params )
    {
